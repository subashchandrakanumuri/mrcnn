...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    # Generate random colors
    colors = colors or random_colors(N, bright=True)
    ...
    print('image returning')
    plt.imsave('C:\\Users\\subhash.k\\desktop\\reddogdisplay\\reddogdjango\\reddogapp\\static\\reddogapp\\images\\savedimg.jpg',masked_image.astype(np.uint8))
    return labels
